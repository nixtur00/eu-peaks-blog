...
This rulebook defines all technical, content, and quality rules an AI system should follow when building a blog about summiting the highest peaks in EU countries using Astro.
...
- Use Astro [Content Collections](https://docs.astro.build/en/guides/content-collections/).
